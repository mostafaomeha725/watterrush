      ...
      child: BlocBuilder<CartCubit, CartState>(
        builder: (context, state) {
          ...
          if (state is CartError) {
            return Center(
              child: AppText(state.message, color: Colors.red, fontSize: 14.sp),
            );
          }
          ...
          if (state is CartLoaded) {
            ...
            final total = (subtotal - discount + delivery).clamp(
              0.0,
              double.infinity,
            );
            ...
            final isApplied =
                state.promoCode != null && state.discountPercentage > 0;
